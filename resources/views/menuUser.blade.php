...
<body class="bg-maroon text-white font-sans">
    ...
    <main class="p-8">
        <table class="w-full border-collapse border border-gray-500">
            <thead>
                <tr>
                    <th class="p-2 border text-bone text-center">No</th>
            ...
            <tbody>
                @foreach ($menus as $menu)
                    <tr>
                        <td class="p-2 border text-bone text-center font-antiquity"> {{ $menu->id }}</td>
                        <td class="p-2 border text-bone font-antiquity">
                            <div class="flex items-center space-x-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center justify-end space-x-4 mt-4 w-full">
                                        <span class="text-lg font-bold justify-center">Rp {{ number_format($menu->price, 0, ',', '.') }}</span>
                                        <button class="bg-maroon3 hover:bg-maroon2 text-white px-4 py-2 rounded">
                                            ORDER
                                        </button>
                                    </div>
                                </div>
